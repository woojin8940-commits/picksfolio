 ...
 * everything (login, Kakao OAuth, payments, settlements …) behaves exactly
 * like the website. The only thing that needs configuring is which web origin
 * to load. `EXPO_PUBLIC_`-prefixed vars are inlined into the
