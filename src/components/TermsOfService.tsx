      ...
      <div className="container mx-auto px-4 sm:px-6 py-16 max-w-4xl">
        ...
        <section className="mb-12">
          ...
          <div className="mb-8">
            ...
            <ul className="space-y-4 text-slate-400 text-sm leading-relaxed">
              <li><span className="text-slate-300 font-bold">정기 구독료:</span> 픽스폴리오 멤버십은 네 가지 플랜으로 운영됩니다. 스탠다드 멤버십(영상 업로드 · 콘텐츠 업로드)은 월 4,900원(VAT 포함), AI 협업 멤버십(스탠다드 혜택 + 협업 AI)은 월 6,900원(VAT 포함), 커머스 멤버십(AI 협업 혜택 + 라이브 커머스 송출)은 월 13,900원(VAT 포함), 프로 플랜(모든 멤버십 혜택 + 인스타그램 디엠 자동화)은 월 18,700원(VAT 포함)이며, 회사의 정책 변경 시 사전 공지 후 조정될 수 있습니다. 비즈니스 수신함과 협업 타임라인은 모든 이용자에게 무료로 제공됩니다.</li>
