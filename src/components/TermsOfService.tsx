        ...
        <section className="mb-12">
          ...
          <div className="mb-8">
            ...
            <ul className="space-y-4 text-slate-400 text-sm leading-relaxed">
              ...
              <li><span className="text-slate-300 font-bold">결제 및 자동 갱신:</span> 멤버십 회원(셀러)은 등록한 결제 수단(신용/체크카드, 토스페이, 카카오페이 등)을 통해 매월 자동으로 구독료를 지불하며, 해지 전까지 서비스 이용 기간은 자동 갱신됩니다.</li>
