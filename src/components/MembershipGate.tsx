    ...
    <div className="p-4 md:p-14 w-full animate-in fade-in duration-500">
      ...
      <div className="max-w-2xl bg-white border border-blue-100 rounded-2xl p-6 md:p-8 shadow-sm">
        <div className="flex items-start gap-3 mb-5">
          <div className="w-10 h-10 rounded-xl bg-blue-100 flex items-center justify-center text-xl">{icon}</div>
          <div>
            <h3 className="text-base md:text-lg font-black text-slate-900">
              {featureName}은(는) 멤버십 전용 기능입니다
            </h3>
            <p className="text-slate-500 text-xs md:text-sm font-medium mt-1">
              월 4,900원 스탠다드 멤버십을 구독하면 내 페이지 영상 커버·콘텐츠 구성을 사용할 수 있습니다. 라이브 커머스 송출까지 원하시면 월 13,900원 커머스 멤버십을 선택하세요.
            </p>
          </div>
        </div>
