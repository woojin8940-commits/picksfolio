 ...
 *
 * 담당자 채널은 협업마다 두 개다. 인플루언서와 담당자만 있는 방(support_inf_*),
 * 브랜드와 담당자만 있는 방(support_biz_*). 양쪽이 서로의 방을 볼 수 없기 때문에
 * 담당자는 두 방을 오가며 말을 옮긴다. 목록 API 는 둘 다 주므로 기본은 인플루언서
 * 방만 보이게 두고, 브랜드 쪽은 칩으로 열어 둔다 — 안 보여주면 담당자가 브랜드에
 * 답할 길이 이 대시보드에 없어진다.
 *
