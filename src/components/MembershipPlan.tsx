    ...
    <main className="p-3 md:p-14 w-full animate-in fade-in duration-500">
      <header className="mb-8 md:mb-12">
        ...
        <p className="text-slate-500 mt-2 text-sm md:text-base">
          스탠다드 멤버십(월 4,900원)으로 영상 커버 · 콘텐츠 구성을 풀고, 커머스 멤버십(월 13,900원)으로 라이브 송출 월 5시간 포함 + 매출 수수료 7.5%(PG 결제 수수료 포함)에 라이브 커머스를 운영할 수 있습니다.
        </p>
      </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 max-w-5xl">
          ...
          <div className="relative rounded-2xl border-2 border-pink-200 bg-white p-6 md:p-8 shadow-sm">
            ...
            <ul className="space-y-2 text-sm text-slate-600 mb-6">
              ...
              <li className="flex items-center gap-2"><span className="text-green-500 font-bold">✓</span><strong>라이브 송출 월 5시간 포함</strong> · 초과분 시간당 4,900원 후불</li>
