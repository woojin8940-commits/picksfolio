  ...
  return (
    <section className="relative pt-24 pb-16 md:pt-48 md:pb-32 container mx-auto px-6 text-center overflow-hidden">
      ...
      >
        ...
        <div className="relative inline-flex flex-col md:flex-row items-center bg-[#11141D] border border-white/5 p-2 md:p-3 rounded-[1.5rem] md:rounded-full w-full md:w-auto shadow-2xl backdrop-blur-xl mb-8">
