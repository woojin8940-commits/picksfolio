        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="w-full aspect-[4/3] md:aspect-[16/9] bg-slate-100 overflow-hidden relative">
            {selectedCampaign.thumbnail_url ? (
              ...
              <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50">
            ...
            <div className="absolute top-4 left-4 flex items-center gap-2 flex-wrap">
              <span className="bg-purple-600 text-white px-3 py-1 rounded-full text-[11px] font-black shadow-lg">
            ...
            {isApplied && (
              <div className="absolute top-4 right-4">
                <span className={`${acceptedCampaigns.has(selectedCampaign.id) ? 'bg-purple-600' : 'bg-emerald-500'} text-white px-3 py-1 rounded-full text-[11px] font-black shadow-lg`}>
          ...
          <div className="px-4 md:px-8">
            ...
            <div className="py-5 border-b border-slate-100">
              <div className="grid grid-cols-2 gap-3">
                ...
                {selectedCampaign.reward_amount && (
                  <div className="col-span-2 bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-100 rounded-2xl p-4 md:p-5">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-8 h-8 bg-purple-100 rounded-xl flex items-center justify-center">
                        <svg className="w-4 h-4 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                      </div>
                      <span className="text-xs text-purple-500 font-black uppercase tracking-wider">리워드</span>
                    </div>
                    <p className="text-2xl font-black text-purple-700">{formatKoreanWon(selectedCampaign.reward_amount)}</p>
                    <span className="text-xs font-bold text-purple-400 mt-1 inline-block">{REWARD_LABELS[selectedCampaign.reward_type] || ''}</span>
                  </div>
                )}
                ...
                <div className="relative pl-6">
                  ...
                  {selectedCampaign.start_date && (
                    <div className="relative mb-5">
                      <div className="absolute -left-6 top-0.5 w-[18px] h-[18px] rounded-full border-2 border-purple-500 bg-white flex items-center justify-center">
                        <div className="w-2 h-2 rounded-full bg-purple-500" />
                      </div>
                      <div>
                        <p className="text-xs font-black text-purple-600">캠페인 시작</p>
              ...
              <div className="bg-white border border-slate-100 rounded-2xl overflow-hidden divide-y divide-slate-50">
                ...
                {selectedCampaign.reward_amount && (
                  <div className="flex items-center px-5 py-3.5">
                    ...
                    <span className="text-sm text-purple-700 font-black">{formatKoreanWon(selectedCampaign.reward_amount)}</span>
                  </div>
                )}
                <div className="flex items-center px-5 py-3.5">
                ...
                {acceptedCampaigns.has(selectedCampaign.id) ? (
                  <div className="space-y-3">
                    ...
                    <button
                      ...
                      className="w-full bg-purple-600 hover:bg-purple-500 text-white py-4 rounded-2xl font-black text-sm transition-all shadow-lg shadow-purple-600/20 flex items-center justify-center gap-2"
                    >
            ...
            {!isApplied && showApplyForm && (
              <div className="py-5">
                <div className="border border-purple-200 rounded-2xl p-5 md:p-6 bg-gradient-to-b from-purple-50/50 to-white space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-slate-200 rounded-xl px-4 py-3 text-sm font-medium text-slate-900 focus:outline-none focus:ring-2 focus:ring-purple-500/20 focus:border-purple-400 bg-white"
                  ...
                  <div className="flex gap-2 pt-2">
                    <button
                      ...
                      className="flex-1 bg-purple-600 hover:bg-purple-500 text-white py-3.5 rounded-xl font-black text-sm transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                      {applying ? (
          ...
          <div className="fixed bottom-0 left-0 right-0 z-30 bg-white/90 backdrop-blur-lg border-t border-slate-100 safe-area-bottom">
            <div className="max-w-3xl mx-auto px-4 py-3 flex items-center gap-3">
              <div className="flex-1 min-w-0">
                {selectedCampaign.reward_amount && (
                  <p className="text-lg font-black text-purple-700 truncate">{formatKoreanWon(selectedCampaign.reward_amount)}</p>
                )}
                {selectedCampaign.max_applicants > 0 && (
              ...
              <button
                ...
                className="bg-purple-600 hover:bg-purple-500 text-white px-8 py-3.5 rounded-2xl font-black text-sm transition-all shadow-lg shadow-purple-600/20 flex items-center gap-2 flex-shrink-0"
              >
