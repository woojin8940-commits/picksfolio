      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
              ...
              <div className="grid grid-cols-3 gap-1 p-1">
                {[...Array(9)].map((_, i) => (
                  <div key={i} className="aspect-square bg-surface-light relative group">
                    <div className="absolute inset-0 bg-purple-primary/20 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    {i === 0 && (
            ...
            {/* Decorative Elements */}
            <div className="absolute -top-10 -left-10 w-40 h-40 bg-purple-primary/20 blur-3xl rounded-full -z-10"></div>
          </motion.div>
