...
const LinkManagement: React.FC<LinkManagementProps> = ({ userName, onNavigateMembership }) => {
  ...
  return (
    <div className="flex h-full bg-[#F8FAFC]">
      ...
      {/* Mobile Preview Area */}
      <div className="hidden lg:flex flex-col w-[520px] xl:w-[620px] 2xl:w-[720px] bg-[#F8FAFC] items-center justify-center px-4 py-1 sticky top-0 h-screen flex-shrink-0">
        <PhoneFrame
          size="xl"
          label="실시간 미리보기"
